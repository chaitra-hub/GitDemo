...
public class SubmitOrderTestdataprovider extends BaseTests {
 ...
 { 
       ...
       // LandingPage landingpages =   launchApplication();
		ProductCatalogue  ProductCatalogue =landingpages.loginapplication(email, password);
 ...
 {
	 return new Object [][] {{"chai.nir@gmail.com", "Test@123", "ZARA COAT 3"}, {"chai.nir1@mailinator.com","Test@123", "ADIDAS ORIGINAL"}};
 }
