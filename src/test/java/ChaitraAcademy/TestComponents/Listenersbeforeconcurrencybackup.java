...
public class Listenersbeforeconcurrencybackup extends BaseTestsJSON implements ITestListener{
	...
	ExtentReports extent = ExtentReporterNG.getReportObject();
	 @Override
	    ...
	    public void onTestFailure(ITestResult result) {
	    	...
	    	test.fail(result.getThrowable()); // if we give this, we want the error message
	  ...
	  try {
		...
		e1.printStackTrace();
	     ...
	     test.addScreenCaptureFromPath(filePath, result.getMethod().getMethodName()); // this we are telling where to store screenshot
	    }
